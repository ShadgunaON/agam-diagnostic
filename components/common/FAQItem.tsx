...
export function FAQItem({ question, answer, isOpen = false, onToggle, className = '' }: FAQItemProps) {
  return (
    <div className={`accordion__item ${isOpen ? 'is-open' : ''} ${className}`}>
      ...
      <div className="accordion__body" style={{ maxHeight: isOpen ? '1000px' : '0', overflow: 'hidden', transition: 'max-height 0.4s ease' }}>
